...
JamRelay est auto-hébergé. L’opérateur protège l’hôte, HTTPS, le proxy, les secrets, les sauvegardes, les logs et les mises à jour. `/data` et `.env` ne doivent jamais être publics.
