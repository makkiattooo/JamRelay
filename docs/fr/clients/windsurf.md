...
Un fallback Bearer peut être envoyé via `headers.Authorization`. Windsurf documente une limite de 100 outils MCP disponibles simultanément; JamRelay reste en dessous.
