...
Bearer-Fallback ist über `headers.Authorization` möglich. Windsurf dokumentiert ein Limit von 100 gleichzeitig verfügbaren MCP-Tools; JamRelay liegt darunter.
