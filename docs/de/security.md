...
JamRelay ist self-hosted. Der Betreiber schützt Host, HTTPS, Proxy, Secrets, Backups, Logs und Updates. `/data`, `.env` und OAuth-Secrets dürfen niemals öffentlich werden.
