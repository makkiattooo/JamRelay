...
Una instancia puede usar múltiples clientes estáticos mediante `MCP_OAUTH_CLIENTS_PATH`, DCR, clientes públicos, clientes confidenciales y opcionalmente `MCP_API_KEY`.
