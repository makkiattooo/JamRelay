...
Puedes usar Bearer como fallback mediante `headers.Authorization`. Windsurf documenta un límite de 100 herramientas MCP disponibles al mismo tiempo; JamRelay está por debajo.
