...
sourceHash: 3d334093a42f
---

# ChatGPT

JamRelay puede conectarse a ChatGPT como MCP remoto mediante HTTPS. Para ChatGPT se recomienda un **cliente OAuth confidencial pre-registrado** y copiar exactamente el callback que muestra ChatGPT.
...
No uses aquí Spotify Client ID/Secret. `MCP_OAUTH_OWNER_SECRET` solo se introduce en la página de aprobación de JamRelay. ChatGPT ya fue verificado end-to-end con el proyecto.
