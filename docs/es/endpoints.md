...
| `GET`                 | `/auth/providers/:provider/start`           | ninguna         | iniciar OAuth del proveedor  |
| `GET`                 | `/auth/providers/:provider/callback`        | estado provider | terminar OAuth del proveedor |
